...
#Use a SELECT statement to order the items in the category of "Kitchen Supplies" by price.
...
#Use a SELECT statement to obtain the number of "Air Purifier" items in stock.
