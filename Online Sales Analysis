# For this project, I used BigQuery to perform analytics on an online sales database. 

SELECT * FROM analytics-2026-503015.sql.user_events LIMIT 1000;
...
FROM analytics-2026-503015.sql.user_events

)

SELECT * FROM funnel_stages;

#2. Identify the conversion rates through the funnel.
...
#4. Analyze the time to conversion. 
...
#5. Create a funnel to analyze revenue.
